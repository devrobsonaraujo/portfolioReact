...
export function Service() {
  ...
  const services = [
    {
      title: "Web",
      description: "Desenvolvimento de sites e sistemas web estáticos e dinâmicos com ReactJS e NextJS",
      icon: <HiComputerDesktop className="h-12 w-12" />
    },
    {
      title: "Sistemas",
      description: "Desenvolvimento de sistemas e APIs REST com NodeJS e Java",
      icon: <HiCommandLine className="h-12 w-12" />
    },
    {
      title: "Mobile",
      description: "Desenvolviento de aplicativos Android",
  ...
  return(
    <section className="container mx-auto my-12 max-w-4xl p-4">
      <div className="p-4 text-center">
        <p className="text-sm font-semibold uppercase text-blue-600">Minha habilidade mais notável</p>
        ...
        <p className="text-sm text-gray-600">Posso atender uma gama completa de serviços, do front-end ao back-end com banco de dados e sistemas
        </p>
      </div>
